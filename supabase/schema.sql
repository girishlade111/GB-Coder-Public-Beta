-- ============================================================================
-- GB CODER - COMPLETE SUPABASE DATABASE SCHEMA
-- ============================================================================
...
-- ============================================================================
-- 3. PROJECT SNAPSHOTS / HISTORY TABLE
-- ============================================================================
...
CREATE POLICY "Users can delete snapshots of their projects"
...
CREATE INDEX snapshots_created_at_idx ON project_snapshots(created_at DESC);
...
CREATE POLICY "Users can view their own private snippets"
  ...
  USING (
    ...
    OR (scope = 'public' AND deleted_at IS NULL)
  );
...
CREATE INDEX snippets_scope_idx ON snippets(scope) WHERE scope = 'public';
